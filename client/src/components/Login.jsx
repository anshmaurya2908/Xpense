        ...
        <div className='h-screen w-[100%] bg-[#1c1c1c] flex justify-center items-center'>
            <div className='bg-[#272727] rounded-xl h-[70vh] w-[80vw] flex flex-col sm:h-[70vh] sm:w-[40vw] lg:h-[70vh] lg:w-[25vw]'>
                ...
                <div className='flex flex-col gap-2 my-[20px] h-[45%] px-4'>
                    ...
                    <input type={showPassword ? 'text' : 'password'} name="Password" placeholder="Password" onChange={handlePassword} className='bg-transparent border border-red-600 text-white h-[40px] px-[10px]' />
                    <button type="button" onClick={() => setShowPassword(!showPassword)} className='flex px-[12px] w-[40px] text-gray-400 font-medium'>{showPassword ? 'Hide' : 'Show'}</button>
                </div>
                ...
                <div className='flex justify-center items-center border-2 border-gray-400 hover:border-orange-400 h-[40px] bg-transparent text-white font-bold mx-4'>
                    <button type="submit" onClick={handleGoogle} className="flex items-center justify-center space-x-2 h-full w-full px-4">
